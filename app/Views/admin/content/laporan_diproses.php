...
<div class="container">
    <div class="wrapper-laporan-diproses">
        <div class="title">
            Laporan laporan Diproses
        </div>
        <div class="filter">
            <?= $this->include('admin/component/filter') ?>
        </div>
        <table class="table table-striped table-laporan-masuk" id="table_laporanDiproses">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Tiket Laporan</th>
...
<script>
    $(document).ready(function() {
        $('#table_laporanDiproses').DataTable({
            dom: 'Bfrtip',
            paging: true,
            pageLength: 10,
            lengthMenu: [
